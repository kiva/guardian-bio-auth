...
interface IBackend {
     ...
     *
     * @param verifyRequest query containing the search parameters
     * @param types helps us decide what types we which to search against
     */
    fun search(verifyRequest: VerifyRequest, types: Array<DataType> = arrayOf(DataType.IMAGE), sdk: IBiometricSDKAdapter? = null): Flux<Identity>
     ...
     */
    fun healthcheck(verifyRequest: VerifyRequest): Mono<Boolean>
