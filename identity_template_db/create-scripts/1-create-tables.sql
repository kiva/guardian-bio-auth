...
-- Modify time is used to store with the template has being modified aka we've sync'ed the fingerprint with the microservice
...
FOR EACH ROW
EXECUTE PROCEDURE trigger_modify_time();
